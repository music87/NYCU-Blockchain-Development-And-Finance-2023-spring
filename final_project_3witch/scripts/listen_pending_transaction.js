...
const test = () => {
    const amount_in = new Decimal(36.817747241457134);
    const reserve_out = new Decimal( 34201582.15782154);
    const reserve_in = new Decimal(156891.78679386454);
    const amount_out = (reserve_out * amount_in) / (parseFloat(reserve_in) + parseFloat((amount_in)));
    process.stdout.write(`[${(new Date).toLocaleTimeString()}] amount_out: ${amount_out}\n`);
}
